...
const UserPage = () => {
    ...
    return (
        <div className="bg-[#FAFAFA] ">
            <div>
                ...
                <div className="flex lg:flex-row flex-col lg:gap-0 gap-[30px] justify-center items-center lg:mx-0 mx-[10vw]">
                    <div className="flex flex-col lg:mr-[100px] p-2">
                        <img className="flex-none md:w-[200px] md:h-[200px] w-[100px] h-[100px] rounded-full p-2" alt={data.profileImageUrl} src={data.profileImageUrl} />
                    </div>
                    <div className="flex flex-col gap-[15px] lg:mr-[100px] mr-[0px] p-2">
                        ...
                        <div className="flex flex-row gap-[50px]">
                            <div className="">
                                <span className="font-bold">{data.images.length}</span> posts
                            </div>
                            ...
                            <button className="" id="followings"
                                    onClick={() => {
                                        ...
                                        setShowModal(true)}} >
                                <span className="font-bold">{data.followings.length}</span> following
                            </button>
                        </div>
            ...
            <Popup onClose={() => setShowModal(false)} visible={showModal} target={modalTarget} userData={data}/>
        </div>
    );
}
